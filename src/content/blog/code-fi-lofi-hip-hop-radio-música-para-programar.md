...
Este género es el **lofi con hip hop alternativo.** Sí, es algo MUY específico pero lo cierto es que este tipo de música está teniendo un éxito particular para ser usada en el estudio, el trabajo y, por supuesto, la _programación_.

Tal es así que **he querido grabar un vídeo donde comparto con todos un tracklist con canciones de este tipo**. Lo he bautizado _code-fi_ y espero que te acompañe en tus horas de _coding_ y _programación_.
...
**El lo-fi es un estilo de música donde para producirla se utilizan equipos viejos.** Se le llama _lo-fi_ porque son sistemas de baja fidelización al grabar. Por eso pierden nitidez pero esa "suciedad" en el sonido la hace estética y, por raro que parezca, **más agradable al oido.**
